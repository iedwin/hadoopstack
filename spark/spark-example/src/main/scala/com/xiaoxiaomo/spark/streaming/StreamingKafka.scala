...
object StreamingKafka {
  ...
  def main(args: Array[String]) {
    ...
    val kafkaParams = scala.collection.immutable.Map[String, String](
      ...
      "group.id" -> "hbaseGroup")
//    val data: InputDStream[(String, String)] = KafkaUtils.createDirectStream(ssc, kafkaParams, topicsSet)
    val stream: InputDStream[(String, String)] = KafkaUtils.createDirectStream[String, String, StringDecoder, StringDecoder](ssc, kafkaParams, topicsSet)
