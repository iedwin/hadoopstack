package com.xiaoxiaomo.metrics.opentsdb;
 ...
 *
 *
 * Created by TangXD on 2017/7/27.
 */
public class OpentsdbClient {
    ...
    public String getData(String metric, String tagk, String tagvFtype, String tagvFilter, String aggregator, String downsample,
        ...
        query.setStart(DateTimeUtil.str2DateTime(startTime, "yyyy-MM-dd HH:mm:ss").getTime() / 1000);
        query.setEnd(DateTimeUtil.str2DateTime(endTime, "yyyy-MM-dd HH:mm:ss").getTime() / 1000);
        ...
        if (array != null) {
            for (int i = 0; i < array.size(); i++) {
                ...
                for (Iterator<String> it = dps.keySet().iterator(); it.hasNext(); ) {
                    ...
                    timeValueMap.put(DateTimeUtil.dateTime2Str(datetime, retTimeFmt), dps.get(timstamp));
                }
