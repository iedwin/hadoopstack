 ...
 *
 * /opt/cloudera/parcels/CDH/bin/spark-submit --class com.xxo.spark.streaming.kafka.JavaDirectKafkaWordCount original-spark_scala-1.0-SNAPSHOT.jar fetch-loadTest-22:9092,fetch-loadTest-25:9092,fetch-loadTest-26:9092 CarrierFetch local[2]
 */
public final class JavaDirectKafkaWordCount {
    ...
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setMaster(args[2]).setAppName("JavaDirectKafkaWordCount");
